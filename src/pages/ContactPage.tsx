...
const contactInfo = [
  ...
  },
  {
    ...
    title: "أوقات العمل",
    value: "8:00 - 18:00",
    description: "التوقيت المحلي الجزائري",
  },
  {
    icon: MapPin,
    title: "العنوان",
    value: "الجزائر",
    description: "منصة تعليمية عبر الإنترنت",
  },
];
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl animate-fade-in" style={{ animationDelay: "0.1s" }}>
              ...
              <p className="text-xl text-white/80">
                نحن هنا لمساعدتك! أرسل لنا استفساراتك وسنرد عليك في أقرب وقت
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="lg:col-span-1 space-y-4">
                {contactInfo.map((info, index) => (
                  <div
                    key={index}
                    className="bg-card rounded-2xl border border-border/50 p-6 shadow-card hover:shadow-card-hover transition-all duration-300 animate-fade-in"
