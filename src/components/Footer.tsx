        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/ProfSofianePhysics/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/10 hover:bg-physics-cyan/30 flex items-center justify-center transition-colors text-white">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.youtube.com/@profsofianephysics" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/10 hover:bg-physics-cyan/30 flex items-center justify-center transition-colors text-white">
                <Youtube className="w-5 h-5" />
              </a>
              <a href="https://t.me/ProfSofianePhysics/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/10 hover:bg-physics-cyan/30 flex items-center justify-center transition-colors text-white">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/level/2as" className="text-white/70 hover:text-physics-gold transition-colors flex items-center gap-2 group">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-physics-gold transition-all duration-300" />
                  السنة الثانية ثانوي
                </Link>
              </li>
              <li>
                <Link to="/level/3as" className="text-white/70 hover:text-physics-gold transition-colors flex items-center gap-2 group">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-physics-gold transition-all duration-300" />
                  السنة الثالثة ثانوي
                </Link>
              </li>
